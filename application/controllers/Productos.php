...
class Productos extends CI_Controller {
    ...
    public function changeEstatusController($id){


        if($this->input->get('switchVal') == 'true')
            { $switchVal = array( 'estatus_id' => '1'); }

            else if($this->input->get('switchVal') == 'false')
                { $switchVal = array( 'estatus_id' => '0'); }
        
        
        $data = $this->productos->changeEstatus($id, $switchVal);
