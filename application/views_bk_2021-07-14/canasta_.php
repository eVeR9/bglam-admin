    ...
    <script>
        window.onload = function () {
            ...
            function renderizarCarrito() {
                ...
                $carrito.textContent = ''; //var querySelector

                // Quitamos los duplicados
                let carritoSinDuplicados = [...new Set(carrito)]; //var array
                ...
                carritoSinDuplicados.forEach(function (item, indice) {
                    ...
                    miNodo.textContent = `${numeroUnidadesItem} x ${miItem[0]['id']} - ${miItem[0]['precio']}€`;
...
<script>
    ...
    let carrito = [];
        ...
        //console.log(data);
        //$('#prueba').val(data['nombre']).html(`<li>${data[0]['nombre']}</li>`);
